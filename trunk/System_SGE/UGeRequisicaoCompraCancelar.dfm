inherited frmGeRequisicaoCompraCancelar: TfrmGeRequisicaoCompraCancelar
  ...
  object cdsRequisicao: TIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      '  inner join TBFORNECEDOR f on (f.codforn = r.fornecedor)'
    ...
    object cdsRequisicaoCODIGO: TIntegerField
      FieldName = 'CODIGO'
    ...
    object cdsRequisicaoNOME_CONTATO: TIBStringField
    ...
    object cdsRequisicaoINSERCAO_DATA: TDateTimeField
    ...
    object cdsRequisicaoEMISSAO_USUARIO: TIBStringField
    ...
    object cdsRequisicaoMOVITO: TMemoField
      FieldName = 'MOVITO'
    ...
    object cdsRequisicaoOBSERVACAO: TMemoField
    ...
    object cdsRequisicaoENDERECO_ENTREGA: TMemoField
    ...
    object cdsRequisicaoVALOR_DESCONTO: TIBBCDField
    ...
    object cdsRequisicaoVALOR_TOTAL_FRETE: TIBBCDField
    ...
    object cdsRequisicaoVALOR_TOTAL_IPI: TIBBCDField
    ...
    object cdsRequisicaoVALOR_TOTAL: TIBBCDField
    ...
    object cdsRequisicaoDATA_FATURA: TDateField
      FieldName = 'DATA_FATURA'
      Origin = '"TBREQUISITA_COMPRA"."DATA_FATURA"'
      ProviderFlags = [pfInUpdate]
    end
    object cdsRequisicaoREQUISITADO_USUARIO: TIBStringField
    ...
    object cdsRequisicaoCANCELADO_USUARIO: TIBStringField
    ...
    object cdsRequisicaoNOMEFORN: TIBStringField
      FieldName = 'NOMEFORN'
      Origin = '"TBFORNECEDOR"."NOMEFORN"'
      ProviderFlags = []
      Size = 100
    end
    object cdsRequisicaoCNPJ: TIBStringField
      FieldName = 'CNPJ'
    ...
    object cdsRequisicaoTRANSPORTADOR_NOME: TIBStringField
      FieldName = 'TRANSPORTADOR_NOME'
      Origin = '"TBFORNECEDOR"."NOMEFORN"'
      ProviderFlags = []
      Size = 100
    end
    object cdsRequisicaoTRANSPORTADOR_CPF_CNPJ: TIBStringField
