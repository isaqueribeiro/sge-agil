  ...
  inherited IbUpdTabela: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into TBPRODUTO'
        ...
        '   PRECO_SUGERIDO, PRODUTO_NOVO, QTDE, REFERENCIA, RENAVAM_VEICU' +
        'LO, RESERVA, '
      
        '   SECAO, SITUACAO_ATUAL_VEICULO, SITUACAO_HISTORICO_VEICULO, TI' +
        'PO_VEICULO, '
      ...
      'values'
        ...
        '   :KILOMETRAGEM_VEICULO, :MODELO, :MOVIMENTA_ESTOQUE, :NCM_SH, ' +
        ':PERCENTUAL_MARCKUP, '
      
        '   :PERCENTUAL_MARGEM, :PERCENTUAL_REDUCAO_BC, :PESO_BRUTO, :PES' +
        'O_LIQUIDO, '
      
        '   :PRECO, :PRECO_PROMOCAO, :PRECO_SUGERIDO, :PRODUTO_NOVO, :QTD' +
        'E, :REFERENCIA, '
