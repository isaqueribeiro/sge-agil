inherited frmGeRequisicaoCompra: TfrmGeRequisicaoCompra
  ...
  inherited tlbBotoes: TToolBar
    ...
    object btnFinalizarRequisicao: TBitBtn
      Tag = 11
      Left = 726
      Top = 2
      Width = 120
    ...
    object btnRequisitarCompra: TBitBtn
      Tag = 12
      Left = 846
      Top = 2
      Width = 120
    ...
    inherited tbsCadastro: TTabSheet
      ...
      inherited GrpBxDadosNominais: TGroupBox
        ...
        object PgcTextoRequisicao: TPageControl
          ...
          Width = 705
          Height = 81
          ActivePage = TbsRequisicaoCancelado
          Style = tsFlatButtons
          TabOrder = 13
  ...
  inherited IbUpdTabela: TIBUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into TBREQUISITA_COMPRA'
        ...
        '  (ANO, CANCELADO_DATA, CANCELADO_MOTIVO, CANCELADO_USUARIO, CLI' +
        'ENTE, CODIGO, '
      
        '   COMPETENCIA, CONDICAO_PAGTO, DATA_FATURA, EMISSAO_DATA, EMISS' +
        'AO_USUARIO, '
      
        '   EMPRESA, ENDERECO_ENTREGA, FORMA_PAGTO, FORNECEDOR, INSERCAO_' +
        'DATA, MOVITO, '
      
        '   NOME_CONTATO, NUMERO, OBSERVACAO, RECEBEDOR_CPF, RECEBEDOR_FU' +
        'NCAO, RECEBEDOR_NOME, '
      
        '   REQUISITADO_DATA, REQUISITADO_USUARIO, STATUS, TIPO, TRANSPOR' +
        'TADOR, '
      ...
      'values'
        ...
        '   :CODIGO, :COMPETENCIA, :CONDICAO_PAGTO, :DATA_FATURA, :EMISSA' +
        'O_DATA, '
