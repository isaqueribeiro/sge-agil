  ...
  object QryDemandaProduto: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  , coalesce(pa.jan, 0.0) as ajan'
        ...
        '  , coalesce(pc.jan, 0.0) - coalesce(pv.jan, 0.0) + coalesce(pa.' +
        'jan, 0.0) as sjan'
      ''
      ...
      '  , coalesce(pa.fev, 0.0) as afev'
        ...
        '  , coalesce(pc.fev, 0.0) - coalesce(pv.fev, 0.0) + coalesce(pa.' +
        'fev, 0.0) as sfev'
      ''
      ...
      '  , coalesce(pa.mar, 0.0) as amar'
        ...
        '  , coalesce(pc.mar, 0.0) - coalesce(pv.mar, 0.0) + coalesce(pa.' +
        'mar, 0.0) as smar'
      ''
      ...
      '  , coalesce(pa.abr, 0.0) as aabr'
        ...
        '  , coalesce(pc.abr, 0.0) - coalesce(pv.abr, 0.0) + coalesce(pa.' +
        'abr, 0.0) as sabr'
      ''
      ...
      '  , coalesce(pa.mai, 0.0) as amai'
        ...
        '  , coalesce(pc.mai, 0.0) - coalesce(pv.mai, 0.0) + coalesce(pa.' +
        'mai, 0.0) as smai'
      ''
      ...
      '  , coalesce(pa.jun, 0.0) as ajun'
        ...
        '  , coalesce(pc.jun, 0.0) - coalesce(pv.jun, 0.0) + coalesce(pa.' +
        'jun, 0.0) as sjun'
      ''
      ...
      '  , coalesce(pa.jul, 0.0) as ajul'
        ...
        '  , coalesce(pc.jul, 0.0) - coalesce(pv.jul, 0.0) + coalesce(pa.' +
        'jul, 0.0) as sjul'
      ''
      ...
      '  , coalesce(pa.ago, 0.0) as aago'
        ...
        '  , coalesce(pc.ago, 0.0) - coalesce(pv.ago, 0.0) + coalesce(pa.' +
        'ago, 0.0) as sago'
      ''
      ...
      '  , coalesce(pa.se, 0.0)  as aset'
        ...
        '  , coalesce(pc.se, 0.0) - coalesce(pv.se, 0.0) + coalesce(pa.se' +
        ', 0.0) as sset'
      ''
      ...
      '  , coalesce(pa.out, 0.0) as aout'
        ...
        '  , coalesce(pc.out, 0.0) - coalesce(pv.out, 0.0) + coalesce(pa.' +
        'out, 0.0) as sout'
      ''
      ...
      '  , coalesce(pa.nov, 0.0) as anov'
        ...
        '  , coalesce(pc.nov, 0.0) - coalesce(pv.nov, 0.0) + coalesce(pa.' +
        'nov, 0.0) as snov'
      ''
      ...
      '  , coalesce(pa.dez, 0.0) as adez'
        ...
        '  , coalesce(pc.dez, 0.0) - coalesce(pv.dez, 0.0) + coalesce(pa.' +
        'dez, 0.0) as sdez'
      'from TBPRODUTO p'
      '  left join TBEMPRESA e on (e.cnpj = p.codemp)'
      '  left join TBGRUPOPROD g on (g.cod = p.codgrupo)'
      ...
      '        a.codprod item'
        ...
        '      , sum(case when extract(month from a.dtajust) = 1 then a.q' +
        'tdeatual else 0 end) as JAN,'
      
        '        sum(case when extract(month from a.dtajust) = 2 then a.q' +
        'tdeatual else 0 end) as FEV,'
      
        '        sum(case when extract(month from a.dtajust) = 3 then a.q' +
        'tdeatual else 0 end) as MAR,'
      
        '        sum(case when extract(month from a.dtajust) = 4 then a.q' +
        'tdeatual else 0 end) as ABR,'
      
        '        sum(case when extract(month from a.dtajust) = 5 then a.q' +
        'tdeatual else 0 end) as MAI,'
      
        '        sum(case when extract(month from a.dtajust) = 6 then a.q' +
        'tdeatual else 0 end) as JUN,'
      
        '        sum(case when extract(month from a.dtajust) = 7 then a.q' +
        'tdeatual else 0 end) as JUL,'
      
        '        sum(case when extract(month from a.dtajust) = 8 then a.q' +
        'tdeatual else 0 end) as AGO,'
      
        '        sum(case when extract(month from a.dtajust) = 9 then a.q' +
        'tdeatual else 0 end) as SE,'
      
        '        sum(case when extract(month from a.dtajust) = 10 then a.' +
        'qtdeatual else 0 end) as OUT,'
      
        '        sum(case when extract(month from a.dtajust) = 11 then a.' +
        'qtdeatual else 0 end) as NOV,'
      
        '        sum(case when extract(month from a.dtajust) = 12 then a.' +
        'qtdeatual else 0 end) as DEZ'
      '    from TBAJUSTESTOQ a'
      '    where extract(year from a.dtajust) = :ano'
      '    group by'
      '        a.codprod'
      '  ) pa on (pa.item = p.cod)')
    Left = 40
