...
/*------ SYSDBA 26/05/2014 10:56:26 --------*/

ALTER TABLE TBCOMPRASITENS ADD IBE$$TEMP_COLUMN
...
F1.RDB$DEFAULT_VALUE  = (SELECT F2.RDB$DEFAULT_VALUE
                         ...
                         WHERE (F2.RDB$RELATION_NAME = 'TBCOMPRASITENS') AND
                               (F2.RDB$FIELD_NAME = 'IBE$$TEMP_COLUMN')),
F1.RDB$DEFAULT_SOURCE = (SELECT F3.RDB$DEFAULT_SOURCE FROM RDB$RELATION_FIELDS F3
                         WHERE (F3.RDB$RELATION_NAME = 'TBCOMPRASITENS') AND
                               (F3.RDB$FIELD_NAME = 'IBE$$TEMP_COLUMN'))
WHERE (F1.RDB$RELATION_NAME = 'TBCOMPRASITENS') AND
      (F1.RDB$FIELD_NAME = 'QTDEANTES');

ALTER TABLE TBCOMPRASITENS DROP IBE$$TEMP_COLUMN;




/*------ SYSDBA 26/05/2014 10:56:32 --------*/
