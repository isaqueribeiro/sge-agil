object frmFormPagto: TfrmFormPagto
  ...
  object ibdtstFPagto: TIBDataSet
    ...
    Left = 208
    Top = 96
    object ibdtstFPagtoCOD: TSmallintField
      FieldName = 'COD'
      Origin = 'TBFORMPAGTO.COD'
      Required = True
    end
    object ibdtstFPagtoDESCRI: TIBStringField
      FieldName = 'DESCRI'
      Origin = 'TBFORMPAGTO.DESCRI'
      Size = 30
    end
    object ibdtstFPagtoACRESCIMO: TFloatField
      FieldName = 'ACRESCIMO'
      Origin = 'TBFORMPAGTO.ACRESCIMO'
    end
  end
  object dtsrcFPagto: TDataSource
    DataSet = ibdtstFPagto
    Left = 288
    Top = 96
  end
end
